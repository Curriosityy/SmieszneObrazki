    ...
    <div class="container" >
      <?php
        ...
        if(isset($_GET["postID"]))
        {
          ...
          $prep->execute([":post_id"=>$_GET["postID"]]);
          $row = $prep->fetch();
      ...
      <div class="lighter row">
        <form class="form-horizontal" action="scripts/editPost.php" method="post">
         ...
         <?php echo '<input type="hidden" class="cPostId" name="postId" value="'.$_GET["postID"].'">'?>
        </form>
      </div>
    </div>
    <!-- Modal -->
