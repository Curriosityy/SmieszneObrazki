<?php
    function printText($userRow,$textRow,$color)
    {
      $userLogin=$textRow["anon"]==1?'Anonim':$userRow["login"];
      $userImage=$userRow["image"];
      $obrazek=$textRow['image']==''?'':"<img class='img-rounded obrazekImg img-responsive' src='".$textRow['image']."' alt='obrazekPostu'>";
      ...
      <div class='row'>
        ...
        <a class='col-sm-3 przycisk'>Komentuj <span class='glyphicon glyphicon-comment'></span></a>
